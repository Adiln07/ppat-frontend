...
const ModalDeleteArticle = ({
  ...
  const fetchArticleById = useAdminArticleStore(
  ...
  const isDeleteArticleClose = useAdminArticleStore(
    (state) => state.iseDeleteArticleClose,
  );

  useEffect(() => {
    if (articleId && isDeleteArticle) {
